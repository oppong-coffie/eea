...
import LabSolutions from "@/app/components/ict-lab/LabSolutions";
...
export const metadata: Metadata = {
  title: "ICT Lab Solutions | Explorers' Edge Academy",
  description: "Explore our turn-key room design, network infrastructure, hardware recommendations, and maintenance services for modern school computer labs.",
};
    ...
    <div className="flex-grow flex flex-col">
      ...
      <section className="relative overflow-hidden isolate py-20 lg:py-28 border-b border-zinc-900 bg-black">
        ...
        <div
          ...
          style={{
            backgroundImage: "url('/images/ict_lab_3d.png')",
            animationDelay: "0s",
          }}
        />
        <div
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 text-center max-w-3xl space-y-4">
          ...
          <AnimateOnScroll type="zoom" delay={0.4}>
            <h1 className="text-4xl sm:text-5xl font-extrabold text-white tracking-tight leading-tight">
              <HoverWord text="ICT Lab Engineering & Solutions" />
            </h1>
          </AnimateOnScroll>

          <AnimateOnScroll type="fade" delay={0.6}>
            <p className="text-lg text-slate-300 font-medium leading-relaxed max-w-2xl mx-auto">
              Partnering with schools to conceptualize, design, and configure smart computer labs that encourage safety, engagement, and hands-on digital exploration.
            </p>
          </AnimateOnScroll>
        </div>
      </section>
      ...
      <div className="py-16 lg:py-24 flex-grow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Lab Solutions Offerings Component */}
