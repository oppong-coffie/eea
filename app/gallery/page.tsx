...
export const metadata: Metadata = {
  title: "Photo Gallery | Explorers' Edge Academy",
  description: "Browse pictures of students coding, assembling robots, writing Python scripts, and presenting projects at Explorers' Edge Academy.",
};
  ...
  return (
    <div className="flex-grow flex flex-col">
      ...
      <section className="relative overflow-hidden isolate py-20 lg:py-28 border-b border-zinc-900 bg-black">
        ...
        <div
          className="absolute inset-0 bg-cover bg-center opacity-0 animate-fade-slideshow-4 -z-20"
          style={{
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 text-center max-w-3xl space-y-4">
          ...
          <AnimateOnScroll type="zoom" delay={0.4}>
            <h1 className="text-4xl sm:text-5xl font-extrabold text-white tracking-tight leading-tight">
              <HoverWord text="Academy Experience Gallery" />
            </h1>
          </AnimateOnScroll>

          <AnimateOnScroll type="fade" delay={0.6}>
            <p className="text-lg text-slate-300 font-medium leading-relaxed max-w-2xl mx-auto">
              Take a look inside our workshops, technology challenges, game design programs, and robotics classes. Hover to inspect, click to expand.
            </p>
          </AnimateOnScroll>
        </div>
      </section>
      ...
      <div className="py-16 lg:py-24 flex-grow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Gallery Grid and Lightbox Component */}
